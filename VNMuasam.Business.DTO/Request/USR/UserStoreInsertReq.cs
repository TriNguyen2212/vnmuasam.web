...
{
    [Validator(typeof(UserStoreInsertReqValidator))]
    //[Serializable]
    [ProtoContract]
    public class UserStoreInsertReq : BaseDTO
    {
        [ProtoMember(1)]
    ...
    public class UserStoreInsertReqValidator : AbstractValidator<UserStoreInsertReq>
    {
        public UserStoreInsertReqValidator()
        {
